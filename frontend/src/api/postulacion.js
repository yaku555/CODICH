...
export const getPostulacionesRequest = () => axios.get('/postulaciones');
...
export const rechazarPostulacionRequest = (rut, comentarioAdmin = '') =>
  axios.patch(`/postulaciones/${rut}/rechazar`, {
    comentarioAdmin,
  });